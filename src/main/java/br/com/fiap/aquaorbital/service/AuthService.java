...
import br.com.fiap.aquaorbital.dto.AuthDTOs.LoginRequest;
import br.com.fiap.aquaorbital.dto.AuthDTOs.RegisterRequest;
import br.com.fiap.aquaorbital.dto.ResponseDTOs.TokenResponse;
import br.com.fiap.aquaorbital.dto.ResponseDTOs.UsuarioResponse;
import br.com.fiap.aquaorbital.entity.Perfil;
import br.com.fiap.aquaorbital.entity.Usuario;
import br.com.fiap.aquaorbital.repository.PerfilRepository;
import br.com.fiap.aquaorbital.repository.UsuarioRepository;
import br.com.fiap.aquaorbital.security.JwtService;
...
public class AuthService {
    ...
    public UsuarioResponse register(RegisterRequest request) {
        ...
        Usuario usuario = usuarioRepository.save(Usuario.builder()
                .nome(request.nome()).email(request.email())
                .senhaHash(passwordEncoder.encode(request.senha()))
                .telefone(request.telefone()).perfil(perfil).build());

        return new UsuarioResponse(usuario.getId(), usuario.getNome(), usuario.getEmail(),
                usuario.getTelefone(), perfil.getNomePerfil(), usuario.getStatus(), usuario.getDtCriacao());
    }
}